		...
		<div id="news">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a href="index.php?menu='.$menu.'&amp;action=1&amp;id=' .$row['id']. '"><img src="img/user.png" alt="user"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action=1&amp;edit=' .$row['id']. '"><img src="img/edit.png" alt="uredi"></a></td>
						<td>' . $row['title'] . '</td>
						<td>';
			...
			<a href="index.php?menu=' . $menu . '&amp;action=1&amp;add=true" class="AddLink">Add news</a>
		</div>';
	}
