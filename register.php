<?php 
	...
	if ($_POST['_action_'] == FALSE) {
        ...
        <div class="card-body">
		<form action="" id="registration_form" name="registration_form" method="POST" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" id="lname" name="lastname" placeholder="Your last name.." required>
                </div>
            </div>
            <div class="row">
            <div class="col-md-12">
		...
		$query  = "SELECT count(*) as count FROM korisnik";
		...
		if ((int)$row['count'] == 0) {
			...
			$query  = "INSERT INTO korisnik (Ime, Prezime, Email, Username, Lozinka, Drzava, Rola)";
